...
$outtoday=mysqli_num_rows($queryinstudents);
 ?> 
                                       <center><p> (<?php echo $outtoday?>)Visitors who have not Signed out of Resident</p></center> 
                                         <thead>
                                        <tr>
                                            <tr>
                  <th>NO.</th>
              ...
              <th>Time Out</th>
               <th>Action</th>
                                       ...
                                       <?php
$ret=mysqli_query($con,"SELECT * FROM `tblvisitor` WHERE `outtime` IS NULL AND TIME(CURTIME())<='23:50:00' ");
$cnt=1;
