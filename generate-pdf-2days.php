...
function Header()
{
    ...
    // Logo
   $this->Image('graduated.png',10,10,50);
...
$result = mysqli_query($con, "SELECT ID, FullName, Student_num, Block, Room, WhomtoMeet, EnterDate, remark, outtime, Res FROM tblvisitor where date(EnterDate)>=(DATE(NOW()) - INTERVAL 2 DAY)") or die("database error:". mysqli_error($con));
