    ...
    <div class="page-wrapper">
      ...
      <?php include_once('includes/sidebar.php');?>
        ...
        <div class="page-container">
            ...
            <!-- END HEADER DESKTOP-->
 <?php
//get number number of students on residents
 $eid=$_GET['editid'];
 $query1=mysqli_query($con,"SELECT ID FROM tblvisitor WHERE Res='$eid' AND date(EnterDate)=CURDATE()");
            ...
            <div class="main-content">
                            ...
                            <div class="col-lg-12">
                                <div class="table-responsive table--no-card m-b-30">
                                    <table class="table table-borderless table-striped table-earning">
                                        <center><p><?php echo $count_yesterday_visitors?> Visitor(s) who have Entered the Selected Resident in 2 Days time</p></center> 
                                         <thead>
                                        <tr>
                                            <tr>
                  <th>NO.</th>
              ...
              <th>Time Out</th>
                   <th>Action</th>
                                       ...
                                       <?php
$eid=$_GET['editid'];
$ret=mysqli_query($con,"SELECT * FROM `tblvisitor` WHERE Res='$eid' AND date(EnterDate)>=(DATE(NOW()) - INTERVAL 2 DAY) AND date(EnterDate)=CURDATE()");
$cnt=1;
...
?>
                ...
                <tr >
                  ...
                  <td><a href="Student-detail.php?editid=<?php echo $row['Student_num'];?>"><?php  echo $row['Student_num'];?></td>
