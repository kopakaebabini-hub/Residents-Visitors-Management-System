                                    ...
                                    <div class="overview__inner">
                                        <div class="overview-box clearfix">
                                            ...
                                            <div class="text">
                                               ...
                                               <a href="manage-Residents-emp.php"> <span>Today's  Visitors</span></a>
                                    ...
                                    <div class="overview__inner">
                                        <div class="overview-box clearfix">
                                            ...
                                            <div class="text">
                                                ...
                                                <a href="Inside-students-emp.php"> <span>No. Of Students In</span> </a>
                                            </div>
                                        </div>
...
<?php
//Last Sevendays visitors
 $query2=mysqli_query($con,"select ID from tblvisitor where date(EnterDate)>=(DATE(NOW()) - INTERVAL 2 DAY);");
$count_lastsevendays_visitors=mysqli_num_rows($query2);
 ?>                       
                                ...
                                <div class="overview-item overview-item--c3">
                                    <div class="overview__inner">
                                        <div class="overview-box clearfix">
                                            ...
                                            <div class="text">
                                                <h2><?php echo $count_lastsevendays_visitors?></h2>
                                                <span>Last 2 Days Visitors</span>
                                            </div>
                                        </div>
