...
if($_SERVER['REQUEST_METHOD'] == 'POST')
{
    ...
    window.location = "/rvms/index.php";
     </script>
                ...
                <div class="login-wrap">
                    <div class="login-content">
                        <div class="login-logo">
                            <a href="/rvms" style="font-size:24px;">
                             Registration Form
                            </a>
                        </div>
                        ...
                        <div class="login-form" >
                            <form action="" method="post">
                             ...
                             <input  type="submit" name="submit" value="Submit" class="au-btn au-btn--block au-btn--green m-b-20."; onclick="display()" />
